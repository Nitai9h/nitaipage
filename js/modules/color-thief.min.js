...
! function(t, n) {
				...
				avg: function(t) {
					...
					if (!n._avg || t) {
						...
						if (n.r1 === n.r2 && n.g1 === n.g2 && n.b1 === n.b2) n._avg = [n.r1 << 3, n.g1 << 3, n.b1 << 3];
							...
							for (i = n.r1; i <= n.r2; i++)
								for (u = n.g1; u <= n.g2; u++)
									for (a = n.b1; a <= n.b2; a++) c += e = r[o(i, u, a)] || 0, f += e * (i + .5) * 8, s += e * (u + .5) * 8, h += e * (a + .5) * 8;
	...
	var u = function() {};
	return u.prototype.getColor = function(t, n) {
		...
		var i = function(t) {
				...
				return (void 0 === r || !Number.isInteger(r) || r < 1) && (r = 10), {
					colorCount: n,
					quality: r
				}
			}({
